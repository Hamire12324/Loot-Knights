...
public sealed class CharacterSkillAfterimageDecoy : MonoBehaviour
{
    private static readonly List<CharacterSkillAfterimageDecoy> Active = new();
    ...
    public static CharacterSkillAfterimageDecoy Create(CharacterCtrl owner, Vector3 position, float duration)
    {
        GameObject instance = new("CharacterSkillAfterimageDecoy");
        instance.transform.position = position;

        CharacterSkillAfterimageDecoy decoy = instance.AddComponent<CharacterSkillAfterimageDecoy>();
        decoy.Owner = owner;
    ...
    public static Transform FindClosest(Vector3 position, float radius)
    {
        ...
        {
            CharacterSkillAfterimageDecoy decoy = Active[i];
            if (decoy == null)
                continue;
    ...
    {
        CharacterSkillAfterimageDecoy decoy = target != null ? target.GetComponent<CharacterSkillAfterimageDecoy>() : null;
