...
public sealed class SkillTreeViewState
{
    private readonly Dictionary<SkillTreeNodeDefinition, SkillTreeNodeViewState> nodeStates;
    private readonly HeroSkillDefinition[] equippedSkills;
    private readonly bool[] occupiedEquipSlots;

    public SkillTreeViewState(
        ...
        Dictionary<SkillTreeNodeDefinition, SkillTreeNodeViewState> nodeStates)
    {
        SkillTree = skillTree;
        ...
        this.nodeStates = nodeStates ?? new Dictionary<SkillTreeNodeDefinition, SkillTreeNodeViewState>();
    }
    ...
    public bool TryGetNodeState(SkillTreeNodeDefinition node, out SkillTreeNodeViewState state)
    {
...
public sealed class SkillTreeNodeViewState
{
    public SkillTreeNodeViewState(
