...
public class LobbyCurrencyView : BaseMonoBehaviour
{
    ...
    public void Refresh()
    {
        ...
        SetText(coinsText, currencyManager.Coins.ToString("N0"));
        SetText(diamondsText, currencyManager.Diamonds.ToString("N0"));
    }
    ...
    {
        PlayerCurrencyManager.Service.Add(CurrencyType.Coins, TestCoinAmount);
    }

    private void AddTestDiamonds()
    {
        PlayerCurrencyManager.Service.Add(CurrencyType.Diamonds, TestDiamondAmount);
    }
